...
const Hero = () => {
    return (
        <section className="w-full flex justify-center min-h-screen sm:min-h-[85vh] md:min-h-[80vh] text-white bg-primary-black">
            <div className="grid grid-cols-1 justify-center md:grid-cols-2">
                ...
                <div className="items-center justify-center relative max-[375px]:w-[240px] w-[320px] h-[140px] md:w-[500px] md:h-[380px] lg:w-[560px] lg:h-[480px]">
                    <Image
