        ...
        <section className="w-full relative flex justify-center min-h-screen sm:min-h-[85vh] md:min-h-[80vh] text-white bg-primary-black">
            ...
            <div className="grid grid-cols-1 justify-center md:grid-cols-2">
                <div className="flex items-center space-y-12 justify-center px-6 md:px-12 flex-col">
                    <motion.h1 className="text-2xl sm:text-4xl md:text-6xl font-medium ">Smile with Confidence</motion.h1>
                    <p className="font-semibold text-xl sm:text-2xl md:text-4xl">Your Partner in Dental Health</p>
                ...
                <div className="items-center justify-center relative z-[0] max-[375px]:w-[240px] w-[320px] h-[140px] md:w-[500px] md:h-[380px] lg:w-[560px] lg:h-[480px]">
                    <Image
